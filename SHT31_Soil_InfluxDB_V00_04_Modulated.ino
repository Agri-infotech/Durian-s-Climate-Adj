...
#define Station_ID "ID-0002: Modulated_Farming"
// Data points
...
void loop() {
  ...
  sensor.addField("Temperature(Modulated)", temp);
 // sensor.addField("Temperature", sht3x.getTemperatureC());
  sensor.addField("Humidity(Modulated)", hum);
  sensor.addField("Vapor Pressure Deficit(Modulated)", VPD);
 // sensor.addField("Humidity", sht3x.getHumidityRH());
  sensor.addField("SoilMoisture(Modulated)", _moisture);
